...
@RestController
@RequestMapping("/api/pointsofsale")
@Validated
...
public class PointOfSaleController {
    ...
    @Operation(
            ...
            description = "Returns a list of all points of sale (sorted by name).",
    ...
    @Operation(
            ...
            description = """
                          ...
                          Optionally, you may pass a numeric 'code' (stable human-friendly code).
                          Requires ADMIN role.
                          """,
            security = @SecurityRequirement(name = "basicAuth"),
    ...
    public ResponseEntity<PointOfSale> create(
        ...
        if (hasCode(req)) {
            created = service.create(req.name(), req.code());
        } else {
            created = service.create(req.name());
        }

        return ResponseEntity
                .created(URI.create("/api/pointsofsale/" + created.id()))
                .body(created);
    }
    ...
    private static boolean hasCode(CreatePointRequest req) {
        try {
            Integer code = req.code();
            return code != null;
